...
- **Public surface synced to the live repo** — metadata, catalog counts, plugin manifests, and install-facing docs now match the actual OSS surface: 71 agents, 282 skills, and 92 legacy command shims.
...
**That's it!** You now have access to 71 agents, 282 skills, and 92 legacy command shims.
...
|---------|---------------------|----------|--------|
| Agents | PASS: 71 agents     | PASS: 12 agents | **Claude Code leads** |
...
|---------|-----------------------|------------|-----------|----------|----------------|
| **Agents** | 71                    | Shared (AGENTS.md) | Shared (AGENTS.md) | 12 | N/A |
