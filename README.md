...
- **Public surface synced to the live repo** — metadata, catalog counts, plugin manifests, and install-facing docs now match the actual OSS surface: 67 agents, 272 skills, and 87 legacy command shims.
...
**That's it!** You now have access to 67 agents, 272 skills, and 87 legacy command shims.
...
| Commands | PASS: 87 commands   | PASS: 35 commands | **Claude Code leads** |
...
| **Commands** | 87                    | Shared | Instruction-based | 35 | 5 prompts |
