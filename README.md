...
- **Public surface synced to the live repo** — metadata, catalog counts, plugin manifests, and install-facing docs now match the actual OSS surface: 69 agents, 278 skills, and 89 legacy command shims.
...
**That's it!** You now have access to 69 agents, 278 skills, and 89 legacy command shims.
...
|---------|---------------------|----------|--------|
| Agents | PASS: 69 agents     | PASS: 12 agents | **Claude Code leads** |
| Commands | PASS: 89 commands   | PASS: 35 commands | **Claude Code leads** |
...
|---------|-----------------------|------------|-----------|----------|----------------|
| **Agents** | 69                    | Shared (AGENTS.md) | Shared (AGENTS.md) | 12 | N/A |
| **Commands** | 89                    | Shared | Instruction-based | 35 | 5 prompts |
