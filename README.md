...
- **Public surface synced to the live repo** — metadata, catalog counts, plugin manifests, and install-facing docs now match the actual OSS surface: 69 agents, 279 skills, and 89 legacy command shims.
...
**That's it!** You now have access to 69 agents, 279 skills, and 89 legacy command shims.
