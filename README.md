...
- **Public surface synced to the live repo** — metadata, catalog counts, plugin manifests, and install-facing docs now match the actual OSS surface: 66 agents, 268 skills, and 86 legacy command shims.
...
**That's it!** You now have access to 66 agents, 268 skills, and 86 legacy command shims.
...
| Commands | PASS: 86 commands   | PASS: 35 commands | **Claude Code leads** |
...
| **Commands** | 86                    | Shared | Instruction-based | 35 | 5 prompts |
