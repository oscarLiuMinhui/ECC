...
- **Public surface synced to the live repo** — metadata, catalog counts, plugin manifests, and install-facing docs now match the actual OSS surface: 65 agents, 264 skills, and 85 legacy command shims.
...
**That's it!** You now have access to 65 agents, 264 skills, and 85 legacy command shims.
